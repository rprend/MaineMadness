...
// bind the form-error modal window to this controller to display any errors //
	...
	this.correctEmail = function(q)
	{
		return q.substr(q.length-9) == "@s207.org" || q.substr(q.length-13) == "@maine207.org";
	}
...
AccountValidator.prototype.validateForm = function()
{
	...
	if (this.correctEmail(this.formFields[1].val()) == false) {
		this.controlGroups[1].addClass('error'); e.push('Please use your @s207.org or @maine207.org email address.');
	}
